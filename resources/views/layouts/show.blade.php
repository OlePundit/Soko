...
<head>
    ...
    <meta name="twitter:description" content="<p>{{$product->description}}</p>">
    <meta name="twitter:image" content="{{$product->user->shop->shopImage()}}">
    <meta name="twitter:site" content="sellorbuyke.com">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:creator" content="@salvacar_ke">
    <meta property="og:type" content="website" />
    <meta property="og:title" content="{{$product->product_name}}"/>
    <meta property="og:description" content="<p>{{$product->description}}</p>" />
