    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6">
            <select name="type" id="type" class="form-select col-md-6" v-model="audioData.type" v-on:change="emitData()">
                ...
                <option value="walkietalkies">Walkie Talkies</option>
                <option value="djmixers">DJ Mixers</option>
                <option value="pasystems">PA systems</option>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6">
            <select name="brand" id="brand" class="form-select col-md-6" v-model="audioData.brand" v-on:change="emitData()">
                ...
                <option value="beatsbydre">Beats by Dre</option>
                <option value="harmankardon">Harman Kardon</option>
