...
<div>
    ...
    <div class="row mb-4">
        <label for="numberplate" class="col-md-4 col-form-label text-md-end">Number Plate</label> 
    ...
    <div class="row mb-4">
        <label for="yom" class="col-md-4 col-form-label text-md-end">Year of Manufacture</label> 
